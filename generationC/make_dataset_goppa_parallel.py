...
# def run_c_batch(binary_path: str, payload: bytes, n: int, m: int, t: int, alpha_m: int,seed :int):
#     env = os.environ.copy()
...
#     res = subprocess.run(
#         [binary_path, str(m), str(t), str(n), str(alpha_m),str(seed)],
#         input=payload,
#         capture_output=True,
#         check=True,
#         env=env,
...
def main():
    ...
    out_dir = f"./data/dataset_goppa_{n}_H5/AT_goppa_nmt_{n}_{m}_{t}"
